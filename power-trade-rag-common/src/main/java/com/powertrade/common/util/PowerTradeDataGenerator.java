 ...
 * 生成 20 份电力交易规则和政策文件
 */
public class PowerTradeDataGenerator {
    ...
    // 文档类型
    private static final String[] DOC_TYPES = {"规则", "办法", "规定", "细则", "指引", "意见", "通知"};
    ...
    public static void main(String[] args) {
        System.out.println("开始生成电力交易测试数据...");
        ...
        try {
            ...
            if (!outputDir.exists()) {
                outputDir.mkdirs();
                System.out.println("创建目录：" + OUTPUT_DIR);
            }
            ...
            for (int i = 0; i < 20; i++) {
                ...
                // 保存为 TXT 文件
                saveDocument(doc);
                System.out.println("生成文档 [" + (i + 1) + "/20]: " + doc.fileName);
            }
